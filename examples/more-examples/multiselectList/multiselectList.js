/**
@example_title uki.more MultiselectList
@example_order 4105
@example_html
    <style>body, html { overflow: hidden; margin: 0; padding: 0; }</style>
    <script src="/src/uki.cjs"></script>
    <script src="/src/uki-more/more/view/multiselectList.cjs"></script>
    <script src="multiselectList.js"></script>
*/
        ...
        leftChildViews: [ // scrollable list on the left
            { view: 'ScrollPane', rect: '200 600', anchors: 'top left right bottom',
                ...
                childViews: { view: 'Box', rect: '10 10 180 900002', anchors: 'top left right', background: '#CCC',
                    ...
                    childViews: { view: 'uki.more.view.MultiselectList', rect: '1 1 178 900000', anchors: 'top left right', 
                            data: data, rowHeight: 30, id: 'list', throttle: 0 }
                }
            }
        ],
        rightChildViews: [ // other controlls on the right
            { view: 'Label', rect: '10 10 100 20', anchors: 'left top', style: { fontSize: '18px' },
                text: 'You can select multiple rows in the lists using Shift or Ctrl (Cmd) key' },
            // main list controlls
            { view: 'Box', rect: '0 50 400 100', anchors: 'left top', childViews: [
            ...
            { view: 'Box', rect: '350 60 300 400', anchors: 'left top', childViews: [
                ...
                { view: 'ScrollPane', rect: '0 30 300 270', anchors: 'left top', childViews: [
                    { view: 'uki.more.view.MultiselectList', rect: '0 0 300 270', anchors: 'left top rigth', minSize: '0 270', data: ['sample #1', 'sample #2', 'sample #3', 'sample #4'], id: 'list2' }
                ]}
            ] }
